...
/**
 * CoordinatesItemsFixture
 *
 */
class CoordinatesItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'size' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
