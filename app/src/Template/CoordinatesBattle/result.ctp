...
foreach ($battle_history as $battle_result) {
    ...
    $a_side_coordinate_class = $b_side_coordinate_class = "result_coordinate_photo";
    ...
    } else if ($battle_result->{"result"} === 0) {
    ...
    echo sprintf('<p class="each_actual_point %s">point : %d</p>',
